...
public class KeywordList {
	...
	webScore.Keyword k11 = new webScore.Keyword("片單", 3);
	webScore.Keyword k12 = new webScore.Keyword("追劇", 4);
	webScore.Keyword k13 = new webScore.Keyword("QIY", 4);
	...
	//webScore.Keyword k17 = new webScore.Keyword("", 3);
	//webScore.Keyword k18 = new webScore.Keyword("", 2);
	webScore.Keyword k19 = new webScore.Keyword("男主角", 2);
	webScore.Keyword k20 = new webScore.Keyword("女主角", 2);
	//webScore.Keyword k21 = new webScore.Keyword("", 2);
